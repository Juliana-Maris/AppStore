...
module.exports = {
    ...
    sendgridKey: 'TBD',// entre aspas colocar link do serviço de email que criar
    containerConnectionString: 'TBD' // aqui colocar o link do azure ou então salvar imagens no mongo nuvem
}
